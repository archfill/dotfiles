...
HYPR_MONITORS_LUA="${SCRIPT_DIR}/monitors.lua"
# =====================================================
# Detect Monitors
# =====================================================
...
return {
    cursor_default_monitor = "${PRIMARY_MONITOR}",
    monitors = {
        {
...
return {
    ...
    monitors = {
        {
            output = "${PRIMARY_MONITOR}",
            mode = "${PRIMARY_WIDTH}x${PRIMARY_HEIGHT}@${PRIMARY_REFRESH}",
            position = "${PRIMARY_X}x${PRIMARY_Y}",
            scale = 1,
            transform = ${PRIMARY_TRANSFORM},
        },
        {
            output = "${SECONDARY_MONITOR}",
            mode = "${SECONDARY_WIDTH}x${SECONDARY_HEIGHT}@${SECONDARY_REFRESH}",
            position = "${SECONDARY_X}x${SECONDARY_Y}",
            scale = 1,
            transform = ${SECONDARY_TRANSFORM},
        },
    },
    workspace_groups = {
        { first = 1, last = 5, monitor = "${PRIMARY_MONITOR}" },
        { first = 6, last = 10, monitor = "${SECONDARY_MONITOR}" },
    },
    window_rules = {},
}
EOF
...
log_success "Generated: $HYPR_MONITORS_LUA"
# =====================================================
# Summary
# =====================================================
